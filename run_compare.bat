...
echo [정보] 현재 시트 데이터를 기준으로 비교 분석을 시작합니다.

.\venv311\Scripts\python src/compare_holdings.py --gs-key 1OluYqwosyYzWLXYh_iGfoMKsbaM6WjVlAiXImDfGWdA
