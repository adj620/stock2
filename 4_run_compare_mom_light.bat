...
:: 맘 계좌 파일 (compare_holdings.py가 사용하는 파일)
set "MINE_KEY=1OluYqwosyYzWLXYh_iGfoMKsbaM6WjVlAiXImDfGWdA"

echo [정보] 기준계좌(잔고_%TARGET_DATE%)와 맘 계좌 비교를 시작합니다.

.\venv311\Scripts\python src/compare_holdings_light.py --base-key %BASE_KEY% --base-tab 잔고_%TARGET_DATE% --mine-key %MINE_KEY% --mine-tab 맘계좌 --target-type mom
